...
REGISTER_DRIVER(XAudio2SoundDriverModern, SND_DRIVER_XA2_MODERN, "XAudio2 Driver Modern", 16)
...
static VoiceCallbackModern voiceCallback;
...
BOOL XAudio2SoundDriverModern::Initialize()
{
	if (g_source != NULL)
	{
		g_source->Start();
...
void XAudio2SoundDriverModern::PlayBuffer(u8* data, int bufferSize)
{
...
DWORD WINAPI XAudio2SoundDriverModern::AudioThreadProc(LPVOID lpParameter)
{
	...
	XAudio2SoundDriverModern* driver = (XAudio2SoundDriverModern*)lpParameter;
...
void __stdcall VoiceCallbackModern::OnBufferEnd(void * pBufferContext)
{
	UNREFERENCED_PARAMETER(pBufferContext);
}

void __stdcall VoiceCallbackModern::OnVoiceProcessingPassStart(UINT32 SamplesRequired)
{
